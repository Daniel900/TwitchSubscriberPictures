...
/// <summary>
/// Rewrites TwitchLib Helix URLs to the Twitch CLI mock API for local UI testing.
/// The Twitch CLI mock server does not implement EventSub HTTP endpoints, so this
/// handler is used only for Helix calls such as broadcaster subscriptions.
/// </summary>
